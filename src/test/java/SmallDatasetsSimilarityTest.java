...
public class SmallDatasetsSimilarityTest {
    ...
    public void test_HLL_onUniqueData() throws CardinalityMergeException {
        /*
         * Similarity 0.1F, means dataset2 consists on 10% from dataset1. HLL is perfect for small similarities on random data
         */
        final float SIMILARITY_01 = 0.1F;
        // 1x7 proportions
        testHLL(SIMILARITY_01, 100, 700, SizeMetric.KBS, SizeMetric.KBS, 3, 0.00F,0.001F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_01, 10_000, 70_000, SizeMetric.KBS, SizeMetric.KBS, 3, 0.00F, 0.001F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_01, 1_000_000, 7_000_000, SizeMetric.MBS, SizeMetric.MBS, 3, 0.00F, 0.001F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        /*
         * Similarity 0.5F, means dataset2 consists on 50% from dataset1
         */
        final float SIMILARITY_05 = 0.5F;
        // 1х2 proportions
        testHLL(SIMILARITY_05, 100, 200, SizeMetric.KBS, SizeMetric.KBS, 3, 0.00F,0.01F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_05, 10_000, 20_000, SizeMetric.KBS, SizeMetric.KBS, 3, 0.00F, 0.01F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_05, 1_000_000, 2_000_000, SizeMetric.MBS, SizeMetric.MBS, 3, 0.00F,0.01F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        // 1х3 proportions
        testHLL(SIMILARITY_05, 100, 300, SizeMetric.KBS, SizeMetric.KBS, 3, 0.089F,0.11F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_05, 10_000, 30_000, SizeMetric.KBS, SizeMetric.KBS, 3, 0.089F, 0.11F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_05, 1_000_000, 3_000_000, SizeMetric.MBS, SizeMetric.MBS, 3, 0.089F, 0.11F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        // 1х4 proportions
        testHLL(SIMILARITY_05, 100, 400, SizeMetric.KBS, SizeMetric.KBS, 3, 0.16F,0.17F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_05, 10_000, 40_000, SizeMetric.KBS, SizeMetric.KBS, 3, 0.16F, 0.17F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_05, 1_000_000, 4_000_000, SizeMetric.MBS, SizeMetric.MBS, 3, 0.16F, 0.17F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        // 1x5 proportions
        testHLL(SIMILARITY_05, 100, 500, SizeMetric.KBS, SizeMetric.KBS, 3, 0.21F,0.22F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_05, 10_000, 50_000, SizeMetric.KBS, SizeMetric.KBS, 3, 0.21F, 0.22F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_05, 1_000_000, 5_000_000, SizeMetric.MBS, SizeMetric.MBS, 3, 0.21F, 0.22F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        // 1x6 proportions
        testHLL(SIMILARITY_05, 100, 600, SizeMetric.KBS, SizeMetric.KBS, 3, 0.24F,0.25F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_05, 10_000, 60_000, SizeMetric.KBS, SizeMetric.KBS, 3, 0.24F, 0.25F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_05, 1_000_000, 6_000_000, SizeMetric.MBS, SizeMetric.MBS, 3, 0.24F, 0.25F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        // 1x7 proportions
        testHLL(SIMILARITY_05, 100, 700, SizeMetric.KBS, SizeMetric.KBS, 3, 0.27F,0.28F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_05, 10_000, 70_000, SizeMetric.KBS, SizeMetric.KBS, 3, 0.27F, 0.28F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_05, 1_000_000, 7_000_000, SizeMetric.MBS, SizeMetric.MBS, 3, 0.27F, 0.28F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        /*
        ...
        // 1x2 proportion
        testHLL(SIMILARITY_07, 100, 200, SizeMetric.KBS, SizeMetric.KBS, 3, 0.07F,0.08F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_07, 10_000, 20_000, SizeMetric.KBS, SizeMetric.KBS, 3, 0.07F, 0.08F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_07, 1_000_000, 2_000_000, SizeMetric.MBS, SizeMetric.MBS, 3, 0.07F,0.08F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        // 1х3 proportions
        testHLL(SIMILARITY_07, 100, 300, SizeMetric.KBS, SizeMetric.KBS, 3, 0.17F,0.18F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_07, 10_000, 30_000, SizeMetric.KBS, SizeMetric.KBS, 3, 0.17F, 0.18F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_07, 1_000_000, 3_000_000, SizeMetric.MBS, SizeMetric.MBS, 3, 0.17F, 0.18F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        // 1х4 proportions
        testHLL(SIMILARITY_07, 100, 400, SizeMetric.KBS, SizeMetric.KBS, 3, 0.24F,0.25F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_07, 10_000, 40_000, SizeMetric.KBS, SizeMetric.KBS, 3, 0.24F, 0.25F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_07, 1_000_000, 4_000_000, SizeMetric.MBS, SizeMetric.MBS, 3, 0.24F, 0.25F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        // 1x5 proportions
        testHLL(SIMILARITY_07, 100, 500, SizeMetric.KBS, SizeMetric.KBS, 3, 0.29F,0.31F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_07, 10_000, 50_000, SizeMetric.KBS, SizeMetric.KBS, 3, 0.29F, 0.31F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_07, 1_000_000, 5_000_000, SizeMetric.MBS, SizeMetric.MBS, 3, 0.29F, 0.31F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        // 1x6 proportions
        testHLL(SIMILARITY_07, 100, 600, SizeMetric.KBS, SizeMetric.KBS, 3, 0.34F,0.35F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_07, 10_000, 60_000, SizeMetric.KBS, SizeMetric.KBS, 3, 0.34F, 0.35F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_07, 1_000_000, 6_000_000, SizeMetric.MBS, SizeMetric.MBS, 3, 0.34F, 0.35F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        // 1x7 proportions
        testHLL(SIMILARITY_07, 100, 700, SizeMetric.KBS, SizeMetric.KBS, 3, 0.37F,0.38F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_07, 10_000, 70_000, SizeMetric.KBS, SizeMetric.KBS, 3, 0.37F, 0.38F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
        testHLL(SIMILARITY_07, 1_000_000, 7_000_000, SizeMetric.MBS, SizeMetric.MBS, 3, 0.37F, 0.38F, UUID_SUPPLIER, DOUBLE_UUID_SUPPLIER);
    }
    ...
    @Test
    public void toDo() {
        //TODO make test on hardly duplicated data or/and data with high probability of collisions
    }
    ...
    private void testHLL(
        ...
        System.out.println(
                String.format(
                        ...
                        similarity, input1Rows, input2Rows, input1Metric, input2Metric, precision, maxExpectedDeviation)
        );
        ...
        HyperLogLogPlus hll1 = measure(SimilarityUtils::createHLL, input1, "Hyper Log Log 1", input1Metric);
        HyperLogLogPlus hll2 = measure(SimilarityUtils::createHLL, input2, "Hyper Log Log 2", input2Metric);
